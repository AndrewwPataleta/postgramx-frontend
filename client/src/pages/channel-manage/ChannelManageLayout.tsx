...
const ChannelManageLayout = () => {
  ...
  const [channel, setChannel] = useState<
    (ChannelEntity & { listings?: ListingEntity[] }) | null
  >(() => {
    if (!id) {
      return null;
    }
        ...
        <div className="py-6 bg-gradient-to-b from-card/50 to-transparent">
          <div className="flex items-center gap-4 mb-4">
            <ChannelAvatar
              ...
              className="h-16 w-16 text-2xl flex-shrink-0"
              fallbackClassName="from-primary/40 to-accent/40"
            />
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                {formatNumber(
                  channel.subscribersCount ?? channel.memberCount ?? 0,
                  language,
                )}{" "}
              ...
              <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                <div>
                  <p className="font-semibold text-warning">
                    {t("channels.pendingVerificationTitle")}
                  </p>
            ...
            {[
              ...
              ...(isOwner
                ? [
                    {
                      id: "moderators",
                      label: t("channelDetails.tabs.moderators"),
                    },
                  ]
                : []),
