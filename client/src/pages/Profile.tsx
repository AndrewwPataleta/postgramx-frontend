...
import ProfileSkeleton from "@/features/auth/ui/skeletons/ProfileSkeleton";
                  ...
                  <div className="grid gap-2 sm:grid-cols-2">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      <select
                        ...
                        onChange={(event) =>
                          updateTransactionFilters({
                            status: (event.target.value || undefined) as TransactionsListFilters["status"],
                          })
                        }
                      ...
                      <select
                        ...
                        onChange={(event) =>
                          updateTransactionFilters({
                            direction: (event.target.value || undefined) as TransactionsListFilters["direction"],
                          })
                        }
                        className="h-10 rounded-md border border-border/40 bg-background/70 px-2 text-xs text-muted-foreground"
                      >
                      ...
                      <select
                        ...
                        onChange={(event) =>
                          updateTransactionFilters({
                            type: (event.target.value || undefined) as TransactionsListFilters["type"],
                          })
                        }
                        className="h-10 rounded-md border border-border/40 bg-background/70 px-2 text-xs text-muted-foreground"
                      >
