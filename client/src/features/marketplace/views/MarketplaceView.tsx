...
import MarketplaceChannelCard from "@/features/channels/ui/MarketplaceChannelCard";
import { ActiveFiltersChips } from "@/design-system/components/ActiveFiltersChips";
import { FilterModal } from "@/design-system/components/FilterModal";
import MarketplaceListSkeleton from "@/features/marketplace/ui/skeletons/MarketplaceListSkeleton";
      ...
      <PageContainer className="pt-4 space-y-6">
        ...
        <div className="space-y-3">
          {state.isLoading && computed.channels.length === 0 ? (
            ...
            <AnimatedList
              key={JSON.stringify(state.filtersKey)}
